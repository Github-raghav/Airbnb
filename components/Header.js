...
function Header({newPlaceHolder}) {
       ...
       />
         ...
         rounded-full py-2 md:shadow-sm ">
          ...
          text-gray-600 placeholder-gray-400"
           type="text" placeholder={newPlaceHolder || "Start your Search"}/>
      ...
      {/* right */}
        ...
        {searhInput && (
            <div className="flex flex-col col-span-3 mx-auto">
                <DateRangePicker
                ranges={[selectionRange]} // it takes values as ranges to show up within range.
                minDate={new Date()}   //you can not use book for yesterday . can book only for today and future.
                rangeColors={["#FD5B61"]}
